...
type StockTransferCreateResponse struct {
	Status string `json:"status"`
	Data   struct {
		ID              string    `json:"id"`
		DocumentCode    string    `json:"document_code"`
		...
		StockTransferItems []struct {
			...
			GroupID struct {
				...
				LastArchivedBy struct {
					...
					MainOutlet  interface{} `json:"main_outlet"`
					Shift       interface{} `json:"shift"`
				} `json:"last_archived_by"`
				LastUnarchivedAt time.Time `json:"last_unarchived_at"`
				LastUnarchivedBy struct {
					ID          string      `json:"id"`
					UsergroupID string      `json:"usergroup_id"`
					Name        string      `json:"name"`
					Email       string      `json:"email"`
...
// StockTransferUpdateResponse ...
type StockTransferUpdateResponse struct {
	Status string `json:"status"`
	Data   struct {
		ID              string    `json:"id"`
		DocumentCode    string    `json:"document_code"`
